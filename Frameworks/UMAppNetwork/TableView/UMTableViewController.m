...
- (void)setupTableView
{
    ...
    _mTableView = [[UMUFPTableView alloc] initWithFrame:self.contentView.bounds style:UITableViewStylePlain appkey:UM_KEY slotId:nil currentViewController:self];
...
{
    [super viewDidLoad];
    [self.naviTitleView setTitle:@"精彩推荐"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    else
    {
        ...
        if (cell == nil) {
            cell = [[UMTableViewLoadingCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"UMTableViewLoadingCell"];
