...
extern NSString *SDWebImageSizeKey;
extern NSString *SDWebImageOptionsKey;
extern NSString *SDWebImageReqUrlKey;
extern NSString *SDWebImageMaskImageKey;
extern NSString *SDWebImageMergeImageKey;
extern NSString *SDDwnloadIndicatorColorKey;
extern NSString *SDWebImageKey;
...
@property (nonatomic,readonly) NSMutableDictionary *webCacheUserInfo;
