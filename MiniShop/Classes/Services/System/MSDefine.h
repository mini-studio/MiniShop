...
//  MiniShop
//
//  Created by Wuquancheng on 13-4-21.
...
#define MOB_TAOBAO_ADD_BAG      @"TAOBAO_ADD_BAG"
#define MOB_TAOBAO_BUY_NOW      @"TAOBAO_BUY_NOW"
#define MOB_TAOBAO_CREATE_ORDER @"TAOBAO_CREATE_ORDER"
